...
$email_id = "school@rkinternational.org";                     // Replace with your email address
...
if(isset($_POST["submit"]))
{
	...
	else
	{
		...
		{	
			...
			$email_msg = "<div><p>Hello,</p><p>You have received a new query from your website www.rkinternational.org, following are the details : </p><p>Name : $contact_name</p><p>Email : $contact_email</p><p>Subject : $contact_subject</p><p>Message : $contact_message</p></div>";
